...
\begin{tikzpicture}[
    grow=down,
    font=\sffamily,
    level 1/.style={sibling distance=6.4cm, level distance=2cm},
    level 2/.style={sibling distance=1.6cm, level distance=2cm},
    level 3/.style={sibling distance=1.3cm, level distance=2cm},
